            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>Aturan Jenis Kulit</h2>
                        <div class="breadcrumb__links">
                            <a href="indexAdmin.php">Beranda</a>
                            <span>Aturan Jenis Kulit</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="hero spad set-bg">
        <div class="container">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md btn-info">
                <a  style="color:white">Tambah Aturan Jenis Kulit </a>&nbsp;&nbsp;<i class="fa fa-plus"></i>
            </button><br><br>
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
						    <a href="controller/prosesAJK.php?id=<?php echo $m['ID_ruleFR']; ?>&aksi=hapus"><button class="btn btn-warning btn-sm"><i class="fa fa-trash-o "></i></button></a>
						</td>
                    </tr>
                <?php
                    }
        ...
        <!-- Model Tambah Aturan Jenis Kulit  -->
		<div id="myModal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
                        <h4> Tambah Aturan Jenis Kulit </h4>
						<align="right"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></align> 
					</div>
					<div class="modal-body">
						<form action="controller/prosesAJK.php?aksi=tambah" method="post">
							...
							<a href="aJenisKulit.php"><button type="button" class="btn btn-default">Batal</button></a>
